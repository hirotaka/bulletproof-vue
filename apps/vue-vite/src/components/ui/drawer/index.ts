import { Dialog as DrawerPrimitive } from 'radix-vue/namespaced'
...
// FIXME: This is a workaround for a bug in the cva typings
// export type DrawerContentProps = VariantProps<typeof drawerVariants> & DialogContentProps
