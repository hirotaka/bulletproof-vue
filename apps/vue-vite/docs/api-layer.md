...
- A composable that consumes the fetcher function that is built on top of libraries such as [TanStack Query](https://tanstack.com/query) ([Vue Query](https://tanstack.com/query/latest/docs/framework/vue/overview)), [apollo-client](https://apollo.vuejs.org/), [urql](https://formidable.com/open-source/urql/), [swrv](https://docs-swrv.netlify.app/), etc. to manage the data fetching and caching logic.
