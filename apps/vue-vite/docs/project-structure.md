...
|
+-- composables       # shared composables used across the entire application
|
...
|
+-- api         # exported API request declarations and api composables related to a specific feature
|
+-- assets      # assets folder can contain all the static files for a specific feature
|
+-- components  # components scoped to a specific feature
|
+-- composables # composables scoped to a specific feature
|
...
You might also want to enforce unidirectional codebase architecture. This means that the code should flow in one direction, from shared parts of the code to the application (shared -> features -> pages). This is a good practice to follow as it makes the codebase more predictable and easier to understand.

As you can see, the shared parts can be used by any part of the codebase, but the features can only import from shared parts and the pages can import from features and shared parts.
