...
module.exports = {
  ...
  actions: (answers) => {
    ...
    return [
      ...
      {
        type: 'add',
        path: componentGeneratePath + '/{{kebabCase name}}/{{kebabCase name}}.vue',
        templateFile: 'generators/component/component.vue.hbs',
      },
      {
        type: 'add',
        path: componentGeneratePath + '/{{kebabCase name}}/{{kebabCase name}}.stories.ts',
        templateFile: 'generators/component/component.stories.ts.hbs',
      },
    ];
  },
};
