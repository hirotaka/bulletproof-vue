...
Enforcing project standards is crucial for maintaining code quality, consistency, and scalability in a Vue application. By establishing and adhering to a set of best practices, developers can ensure that the codebase remains clean, organized, and easy to maintain.
...
The [Vue Style Guide](https://vuejs.org/style-guide/rules-strongly-recommended.html#single-file-component-filename-casing) recommends either **PascalCase** or **kebab-case** for Single-File Components, with consistency being the key. This project uses kebab-case for cross-platform compatibility (case-insensitive file systems).
...
'check-file/filename-naming-convention': [
  ...
  {
      // ignore the middle extensions of the filename to support filename like vite.config.ts or button.stories.ts
