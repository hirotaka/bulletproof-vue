...
|
+-- composables       # encapsulate and reuse stateful logic used across the entire application
|
...
|
+-- composables # encapsulate and reuse stateful logic scoped to a specific feature
|
